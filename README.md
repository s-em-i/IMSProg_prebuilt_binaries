...
Prebuilt Binaries for serveral OS to run **[IMSProg]([https://core.telegram.org/api/obtaining_api_id](https://github.com/bigbigmdm/IMSProg))** from Mikhail Medvedev (bigbigmdm).
